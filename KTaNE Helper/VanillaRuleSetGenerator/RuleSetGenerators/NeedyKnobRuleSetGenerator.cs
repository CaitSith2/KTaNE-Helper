...
public class NeedyKnobRuleSetGenerator : AbstractRuleSetGenerator
{
	...
	protected List<bool[]> GeneratePossibilities(int numRules)
	{
		...
		do
		{
			...
			list2.Add(this.intToBoolArray(a, NeedyKnobRuleSetGenerator.LED_COLS * NeedyKnobRuleSetGenerator.LED_ROWS));
			list2.Add(this.intToBoolArray(a2, NeedyKnobRuleSetGenerator.LED_COLS * NeedyKnobRuleSetGenerator.LED_ROWS));
			list2.Add(this.intToBoolArray(a3, NeedyKnobRuleSetGenerator.LED_COLS * NeedyKnobRuleSetGenerator.LED_ROWS));
			list2.Add(this.intToBoolArray(a4, NeedyKnobRuleSetGenerator.LED_COLS * NeedyKnobRuleSetGenerator.LED_ROWS));
		}
		while (list2.Count < numRules);
		return list2;
	}

	protected bool[] intToBoolArray(int a, int arraySize)
	{
